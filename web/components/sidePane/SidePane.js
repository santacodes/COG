    ...
    return (
        <div className="flex flex-col w-64 h-screen bg-gray-900 text-gray-300 shadow-lg overflow-hidden">
            ...
            <nav className="flex flex-row justify-center space-x-4 p-4 bg-gray-900">
                <button
                    className={`flex items-center justify-center w-12 h-12 rounded-lg transition ${activeTab === "tab1"
                ...
                <button
                    className={`flex items-center justify-center w-12 h-12 rounded-lg transition ${activeTab === "tab2"
                        ? "bg-gray-600 hover:bg-gray-700 shadow-md"
                        : "bg-gray-800 hover:bg-gray-700 shadow-md"
                        }`}
                ...
                <button
                    className={`flex items-center justify-center w-12 h-12 rounded-lg transition ${activeTab === "tab3"
                        ? "bg-gray-600 hover:bg-gray-700 shadow-md"
                        : "bg-gray-800 hover:bg-gray-700 shadow-md"
                        }`}
